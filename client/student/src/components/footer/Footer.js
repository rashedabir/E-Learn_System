                ...
                <Container>
                    <Grid container spacing={6}>
                        ...
                        <Grid item xs={12} md={3}>
                            Contact US
                            <p className={classes.contact}><LocalPhoneIcon className={classes.ico} />  +00 123 456 789</p>
                            <p className={classes.contact}><MailOutlineIcon className={classes.ico} />  info@udemy.inc</p>
                            <p className={classes.contact}><AddLocationIcon className={classes.ico} />  lorem ipsum Road,
